...
## Run cluster via docker-compose (WIP)
...
TODO:
- How to change admin username and password just by modifying docker-compose.yml
- How to add another node by modifying docker-compose.yml and haproxy.cfg
- Note about cookie and secret
